...
int main()
{
    ...
    for (const auto& student : studentVector) std::cout << *student << '\n';
    std::cout << '\n';
    ...
    std::cout << "Searching for a student named \"" << searchByName << "\": " << *( * studentIterator) << '\n';
    ...
    std::cout << "Searching for a student of age \"" << searchByAge << "\": " << *(*studentIterator) << '\n';
    ...
    std::cout << "Searching for a student of age \"" << searchByGrade << "\": " << *(*studentIterator) << '\n';
